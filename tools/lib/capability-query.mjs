const allowedActions = new Set(["interrupt", "purge", "cleanse-magic", "cleanse-curse", "cleanse-disease", "cleanse-poison", "soothe", "defensive", "crowd-control", "enemy-reposition", "external-defensive", "external-offensive", "battle-resurrection", "party-damage-reduction", "bloodlust", "group-buff"]);
