...
test("reports explicit full-matrix and capability-only coverage", () => {
  ...
  assert.equal(report.summary.matrixSpecCount, 11);
  assert.equal(report.summary.fullMatrixSpecCount, 11);
  assert.equal(report.summary.capabilityOnlySpecCount, 10);
